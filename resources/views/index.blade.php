...
<body>
    ...
    <div id="topbar" class="d-flex align-items-center fixed-top">
        <div class="container d-flex justify-content-center justify-content-md-between">
            ...
            <div class="contact-info d-flex align-items-center">
                <i class="bi bi-phone d-flex align-items-center"><span>+880 1814 2508 83</span></i>
                <i class="bi bi-clock d-flex align-items-center ms-4"><span> Mon-Sat: 11AM - 11:59PM</span></i>
            </div>
    ...
    <header id="header" class="fixed-top d-flex align-items-cente">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
            ...
            {{-- <a href="{{ route('register') }}" class="book-a-table-btn scrollto d-none d-lg-flex">Register</a> --}}
            @if (Route::has('login'))
                @auth
                    @if (Auth::user()->user_type == 1)
                        <a href="{{ route('admin.dashboard') }}"
                            class="book-a-table-btn scrollto d-none d-lg-flex">Dashboard</a>
                    @endif
                    ...
                    <a onclick="event.preventDefault(); document.querySelector('#logout-form').submit();"
                        href=" {{ route('logout') }}" class="book-a-table-btn scrollto d-none d-lg-flex">Log out</a>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
                    @foreach ($items as $item)
                        <div class="col-lg-6 menu-item filter-{{ $item->category->slug }}">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="{{ asset('frontend') }}/assets/img/event-birthday.jpg"
                                        class="img-fluid" alt="">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="{{ asset('frontend') }}/assets/img/event-private.jpg"
                                        class="img-fluid" alt="">
                                </div>
                                <div class="col-lg-6 pt-4 pt-lg-0 content">
                        ...
                        <div class="swiper-slide">
                            <div class="row event-item">
                                <div class="col-lg-6">
                                    <img src="{{ asset('frontend') }}/assets/img/event-custom.jpg"
                                        class="img-fluid" alt="">
                                </div>
                                <div class="col-lg-6 pt-4 pt-lg-0 content">
        ...
        <section id="book-a-table" class="book-a-table">
            <div class="container" data-aos="fade-up">
                ...
                <form action="{{ route('reservation.store') }}" method="POST" class="php-email-form"
                    data-aos="fade-up" data-aos-delay="100" role="form">
                    @csrf
                    <div class="row">
                    ...
                    <div class="text-center"><button name="submit" type="submit">Book a Table</button></div>
                </form>
                        ...
                        @foreach ($testimonials as $testimonial)
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <img src="{{ asset('storage/') . '/' . $testimonial->profile_photo_path }}"
    ...
    <footer id="footer">
        ...
        <div class="container">
            ...
            <div class="credits">
                ...
                Designed by <a target="_blank" href="https://mohammed-mohsin.github.io/portfolio/">Mohsin</a>
            </div>
        </div>
    </footer><!-- End Footer -->
